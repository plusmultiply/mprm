...
from utils.trainer_original import ModelTrainer
from models.KPFCNN_model_original import KernelPointFCNN

# Dataset
from datasets.Scannet_on_pseudo_label import ScannetDataset
...
class ScannetConfig(Config):
    ...
    saving = True
    saving_path = '/mnt/sdc1/jiacheng/kp_results/final_result'
