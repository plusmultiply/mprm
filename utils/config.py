...
class Config:
    ...
    def save(self, path):
        ...
        with open(join(path, 'parameters.txt'), "w") as text_file:
            ...
            #text_file.write('branch_weights = {:f}\n'.format(self.branch_weights))
            #text_file.write('branch_loss_weights = {:f}\n'.format(self.branch_loss_weights))
            text_file.write('dropout_threshold = {:f}\n'.format(self.dropout_threshold))
            text_file.write('dropout_prob = {:f}\n'.format(self.dropout_prob))
            text_file.write('setting = {:s}\n'.format(self.setting))
